...
import { normalizeProject, projectPayload, createStorageFileName } from "../../utils/portfolio";
...
export default function Projects() {
  ...
  const uploadImage = async (f) => {
    const fileName = createStorageFileName("project", f);
  ...
  const handleCreate = async (form, file) => {
    ...
    try {
      ...
      const { error } = await supabase
        .from("projects")
        .insert(projectPayload({ ...form, Img: imgUrl }));
  ...
  const handleEdit = async (form, file) => {
    ...
    try {
      ...
      const { error } = await supabase
        .from("projects")
        .update(projectPayload({ ...form, Img: imgUrl }))
