        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Berfokus pada Graphic Design, Fullstack Web Development, dan UI/UX
              Design, dengan pengalaman dalam merancang identitas visual serta
              mengembangkan website bisnis, e-commerce, dan company profile
              menggunakan Laravel, Next.js, dan React.js. Menggabungkan
              kreativitas desain dan kekuatan teknologi untuk menciptakan produk
              digital yang menarik secara visual, fungsional, dan berorientasi
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="/cv-muhammad-arif-irfan.pdf"
                download="cv-muhammad-arif-irfan.pdf"
