...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const storedProjects = (JSON.parse(localStorage.getItem("projects")) || []).map(normalizeProject);
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://www.linkedin.com/in/muhammadarifirfann/",
      };
  ...
  const projectUrl = `https://muhammad-arif-irfan.vercel.app/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Muhammad Arif Irfan</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Muhammad Arif Irfan — Fullstack Web Developer | UI/UX Designer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Muhammad Arif Irfan`}
        />
        <meta
